...
import type { FormFactor, Audit, AuditResult, LHAuditResult, ErrorAudit, PWAAudits } from './types.js';
...
export default class Auditor {
    ...
    _auditPWA(params: any, auditsToBeRun?: PWAAudits[]): Promise<AuditResult>;
}
